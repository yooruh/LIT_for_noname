...
export const translate = {
    ...
    'lit_shengjiqb': '升级·Qb',
    'lit_shengjiqb_info': `${get.poptip("lit_tiannaV2")} 于“天呐”末尾增加：>1血受伤时若此伤害会使血<1，免伤且血掉至1`,
    'lit_shengjizsj': '升级·张盛杰',
    'lit_shengjizsj_info': `${get.poptip("lit_wutouV2")} 于“无头”中增加：结束阶段，可强制移动场上的1牌`,
    'lit_shengjizqy': '升级·张钦奕',
    'lit_shengjizqy_info': `${get.poptip("lit_zishaV2")} 于“紫砂”开头增加：准备阶段，可失去1点体力，+2牌`,
    'lit_shengjipjl': '升级·庞建龙',
    'lit_shengjipjl_info': `${get.poptip("lit_duilianV2")} 修改“对练”：不需要弃牌了`,
    'lit_shengjiwxq': '升级·伍小戚',
    'lit_shengjiwxq_info': `${get.poptip("lit_mianjuV2")} 修改“小丑”：使其弃全部牌`,
    'lit_shengjizg': '升级·自高',
    'lit_shengjizg_info': `${get.poptip("lit_zhanshiV2")} 修改“展示”：你也拥有后半段技能`,
    'lit_shengjizpj': '升级·曾品嘉',
    'lit_shengjizpj_info': `${get.poptip("lit_saohuaV2")} 修改“骚话”：此技能中，点数<7的牌计算时的点数+7`,
    'lit_shengjibs': '升级·菠树',
    'lit_shengjibs_info': `${get.poptip("lit_yisuiV2")} 修改“易碎”：闺蜜死亡时，你不再失去体力`,
    'lit_shengjilcm': '升级·刘晨沐',
    'lit_shengjilcm_info': `${get.poptip("lit_jijinV2")} 修改“受激”：伤害越高，受激叠层越多`,
    'lit_shengjizmh': '升级·郑墨翰',
    'lit_shengjizmh_info': `${get.poptip("lit_jianrenV2")} 于“坚韧”末尾增加：横置时属性伤+1`,
    'lit_shengjirita': '升级·Rita',
    'lit_shengjirita_info': `${get.poptip("lit_dafang")}${get.poptip("lit_hengshuitiV2")}若已拥有“大方”，则于“衡水体”中增加：+1血；否则，获得“大方”`,
    'lit_shengjihp': '升级·胡畔',
    ...
    'lit_shengjihxy_info': `${get.poptip("lit_shihuaiV2")} 修改“释怀”选项②：交给你1张装备牌`,
    'lit_shengjihjw': '升级·胡峻玮',
    'lit_shengjihjw_info': `${get.poptip("lit_wutongV2")}修改“梧桐”条件：还可弃置全部手牌触发`,
    'lit_shengjijhx': '升级·蒋海旭',
    'lit_shengjijhx_info': `${get.poptip("lit_shanliangV2")}于“善良”末尾增加：若恢复量溢出，增加等溢出量的上限后回满血`,
    'lit_shengjiqbc': '升级·钱保灿',
    'lit_shengjiqbc_info': `${get.poptip("lit_chushouV2")}修改“出手”：不再跳过摸牌阶段`,
    'lit_shengjizc': '升级·张驰',
    'lit_shengjizc_info': `${get.poptip("lit_shuxinV2")}修改“竖心”：不再为锁定技`,
    ...
    'lit_qiantui_info': `血由3以上掉到3及以下时，可令不带有${get.poptip("lit_kuanshu")}的1人获得${get.poptip("lit_qianfan")}`,
		/*负面效果*/'lit_qianfan': '遣返',
    'lit_qianfan_info': `负面效果：下回合开始前，跳回合，获得${get.poptip("lit_kuanshu")}，“宽恕”在下回合开始时失效`,
    'lit_kuanshu': '宽恕',
	...
	/*负面效果*/'lit_shouji': '受激',
    'lit_shouji_info': '负面效果：下个用杀者强制选择你为目标（无视距离）',
    // 郑墨翰
    'lit_mensao': '闷骚',
    'lit_mensao_info': '出牌阶段限1次，将1牌作“铁索连环”使用或重铸，然后令场上横置者+1血',
    'lit_jianren': '坚韧',
    ...
    'lit_fumeng': '浮梦',
    'lit_fumeng_info': `出牌阶段限1次，选择体力上限>1的1人，令其${get.poptip("lit_mengying")}层数+<span style='color:lightblue'>X</span>（<span style='color:lightblue'>X</span>为其已损失的血量且至少为1）`,
	/*负面效果*/'lit_mengying': '梦萦',
    'lit_mengying_info': '负面效果：每层-1体力上限，每+1血-1层',
    // 兰柏勋
    'lit_yuqiu': '欲求',
    ...
    'lit_male': '麻了',
    'lit_male_info': `${Styled('r', '杀可使用次数+1')}；造成伤害前，若此牌与上次同名（所有杀算1种），可判定，若为：<br>①♥♦ ${Styled('r', '本回合杀、决斗目标数+1')}；<br>②♠♣ 本回合非红色部分失效，取消本次伤害，+1牌`,
    'lit_male_tag': '同名',
    // 张驰
    'lit_guibian': '诡辩',
...
//     str += get.translation(char)+` hp = ${character.maxHp != character.hp ? `${character.hp}/${character.maxHp}` : character.hp}：\n`;
