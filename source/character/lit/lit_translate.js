...
export const translate = {
    ...
    // 9张驰
    'lit_bolun': "悖论",
    'lit_bolun_info': `你可以扣置1张手牌并声明1种普通锦囊牌或基本牌的牌名，视为你使用或打出你声明的牌，其余多人可同时质疑：<li>①为真（声明的牌与扣置的牌不相符）：此牌无效，质疑者摸1张牌。<li>②反之：此牌依然生效，质疑者选择1项：①随机失去1~2点体力；②获得${get.poptip('lit_jiqing')}<br>（被质疑成功后本回合不可再悖论此牌）`,
    'lit_bolun_ally': "信任",
    'lit_bolun_betray': "质疑",
    'lit_bolun_ally_bg': "真",
    ...
    // 林淼
    'lit_shenge': "神鸽",
    'lit_shenge_info': "用杀时可选距离≤此牌点数者为目标。杀指定目标后，可触发以下效果：<br>①体力≤目标体力时，对此目标的此杀伤害+1；<br>②手牌数≤目标区域牌时，杀无视防具且不可被响应。",
    'lit_gugu': "咕咕",
    ...
    // 张盛杰
    'lit_wutou': "无头",
    'lit_wutou_info': "锁；回合开始前跳准备和判定，此后可强制移动场上1牌；延时锦囊牌可对自己使用",
    'lit_wutouV2': "无头V2",
    'lit_wutouV2_info': "V2 锁；回合开始前跳准备和判定，此后或结束阶段，可强制移动场上1牌；延时锦囊牌可对自己使用",
    'lit_youxia': "游侠",
    ...
    'lit_duilian': "对练",
    'lit_duilian_info': "出牌阶段限1次，弃1张牌，选择任意对人使其相互决斗，不可无懈",
    'lit_duilianV2': "对练V2",
    'lit_duilianV2_info': "V2 出牌阶段限1次，选择任意对人使其相互决斗，不可无懈",
    // 伍小戚
    'lit_shencaocao': "神曹操",
    ...
    'lit_mianju': "面具",
    'lit_mianju_info': `锁；起始获得4“面”，每次濒死后回满血并移除等量“面”，“面”耗尽时失去此技能并获得${get.poptip('lit_xiaochou')}`,
    'lit_mianjuV2': "面具V2",
    'lit_mianjuV2_info': `V2 锁；起始获得4“面”，每次濒死后回满血并移除等量“面”，“面”耗尽时失去此技能并获得${get.poptip('lit_xiaochouV2')}`,
    'lit_xiaochou': "小丑",
    ...
    'lit_yinren': "殷刃",
    'lit_yinren_info': "每回合限1次，需要使用或打出杀时，可-1血，视为使用无距离和次数限制的杀，若造成伤害，+1血",
    'lit_fumeng': "浮梦",
    ...
    // 王荣
    'lit_manmanlai': "慢慢来",
    'lit_manmanlai_info': "主；未持有“吊诡”的“叁”势力角色，可于准备阶段弃置判定区的1张牌，然后你+1血",
    /*负面效果*/'lit_diaogui': "吊诡",
    'lit_diaogui_info': "负面；兵乐必中，在一轮开始时（含游戏开始时），可-1血转移给其他人",
    'lit_kushi': "苦诗",
    'lit_kushi_info': "锁；你或攻击范围内的角色每进行一次判定，你摸1张牌",
    'lit_qixu': "期许",
    'lit_qixu_info': `出牌阶段，可令1人判定，让其猜测判定的花色：若猜错，你按实际花色，令其进行♠闪电、♥乐、♣兵、♦遣返牌的判定；若猜中，你失去此技能并获得${get.poptip('lit_zhijian')}`,
    'lit_qixuV2': "期许V2",
    'lit_qixuV2_info': `V2 出牌阶段，可令1人判定，让其猜测判定的花色：若猜错，你按实际花色，令其进行♠闪电、♥乐、♣兵、♦遣返牌的判定；若猜中，你获得${get.poptip('lit_zhijian')}`,
    'lit_zhijian': "执剑",
    'lit_zhijian_info': `使用杀指定目标后可判定：♥♦可扣置目标至多${X}张牌于武将牌上，其于杀结算后获得之；♠♣对此目标的此杀伤害+1（${X}为其体力值）`,
    // 蒋海旭
    'lit_yuanzhu': "援助",
    ...
    // 钱保灿
    'lit_chushou': "出手",
    'lit_chushou_info': "锁；回合开始前，跳过摸牌阶段，视为使用1张你声明的锦囊牌，不可无懈",
    'lit_chushouV2': "出手V2",
    'lit_chushouV2_info': "V2 锁；回合开始前，视为使用1张你声明的锦囊牌，不可无懈",
    'lit_zhixun': "质询",
    'lit_zhixun_info': "牌的目标不为1时，可取消其中1个目标，视为对1人再次使用此牌",
    'lit_male': "麻了",
    'lit_male_info': `造成伤害前，若此牌与上次同名，可判定，若为：<br>①♥♦ ${Styled('r', '本回合杀、决斗目标数+1')}；<br>②♠♣ 本回合非红色部分失效，取消本次伤害，+1牌`,
    'lit_male_tag': "同名",
    'lit_male_faq': "“杀”的同名：",
    ...
    // 杨湘铃
    'lit_lenmo': "冷漠",
    'lit_lenmo_info': `锁；造成伤害前，若其不为你，且攻击范围内不包括你，则令其获得一层${get.poptip('lit_dongjie')}，若此时冻结层数大于其体力值，其翻面`,
    /*负面效果*/'lit_dongjie': "冻结",
...
export const dynamicTranslate = {
    ...
    lit_mianju(player) {
        if (get.mode() === 'guozhan') return `锁；起始或明置角色后，若无“面”，获得4“面”，每次濒死后回满血并移除等量“面”，“面”耗尽时失去此技能并获得${get.poptip('lit_xiaochou')}`;
        return `锁；起始获得4“面”，每次濒死后回满血并移除等量“面”，“面”耗尽时失去此技能并获得${get.poptip('lit_xiaochou')}`;
    },
    // 状态改动
    ...
    lit_saohua(player) {
        let str = "已用和打出牌可置于角色上。出牌阶段可：<li>将2张点数和≥13的牌当“闪电”</li>";
        if (player.hasSkill('lit_saohuaV2')) str = "V2 已用和打出牌可置于角色上，点数<7的牌在此技能中点数+7。出牌阶段可：<li>将2张点数和≥13的牌当“闪电”</li>";

        if (player.hasSkill('lit_saohua_pi')) str += Styled('o', "<li>弃3张点数和=33的牌，造成3点雷伤（本项每回合限1次）</li>");
        else str += "<li>弃3张点数和=33的牌，造成3点雷伤（本项每回合限1次）</li>";
        return str;
    },
    lit_qixu(player) {
        if (player.hasSkill('lit_qixuV2')) return `V2 出牌阶段，可令1人判定，让其猜测判定的花色：若猜错，你按实际花色，令其进行♠闪电、♥乐、♣兵、♦遣返牌的判定；若猜中，你获得${get.poptip('lit_zhijian')}`;
        return `出牌阶段，可令1人判定，让其猜测判定的花色：若猜错，你按实际花色，令其进行♠闪电、♥乐、♣兵、♦遣返牌的判定；若猜中，你失去此技能并获得${get.poptip('lit_zhijian')}`;
    },
    lit_male(player) {
        if (player.isTempBanned('lit_male_judge')) return `${Styled('o', '造成伤害前，若此牌与上次同名（所有杀算1种），可判定，若为：')}<br>`
            + `①♥♦ ${Styled('r', '本回合杀、决斗目标数+1')}；<br>`
            + `${Styled('o', '②♠♣ 本回合非红色部分失效，取消本次伤害，+1牌')}`;
        return `造成伤害前，若此牌与上次同名（所有杀算1种），可判定，若为：<br>①♥♦ ${Styled('r', '本回合杀、决斗目标数+1')}；<br>②♠♣ 本回合非红色部分失效，取消本次伤害，+1牌`;
    },
    lit_xiaosa(player) {
