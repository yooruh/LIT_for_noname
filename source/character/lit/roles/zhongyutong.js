...
export const skill = {
    ...
    lit_chuanshuoV2: {
        ...
        forced: true,
        init(player) {
            if (player.hasSkill('lit_yaobian')) {
                player.removeSkill('lit_yaobian');
                return;
            }
            player.turnOver(true);
        },
...
export const translate = {
    ...
    'lit_chuanshuo': "传说",
    'lit_chuanshuo_info': "①你进入游戏时（含因更换角色牌进入游戏时）翻至背面。②你体力值每减少1点，进行一次翻面。③你翻至正面时，立刻翻至背面。④你每翻面一次后，可令1人获得2点护甲。⑤全局技，全场有人护甲量≥3时，其连续失去3点护甲，直至其护甲量小于3。其每因此失去了3点护甲，其+1点体力上限",
