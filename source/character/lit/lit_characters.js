...
export const characterIntro = {
    ...
    'lit_zhangshengjie张盛杰': `典型的发育角色，${B("张盛杰")}发育完成的那一瞬间爆发很强，前后期都比较弱。能免疫除${get.poptip("lit_qixu")}外的延时锦囊牌，在后置位发育会相对舒服，必要时可以让队友帮一把。`
        + "<li>主公：发育相对较快，觉醒后如果血量健康，可以不着急输出，凑多一点延时锦囊牌可以让输出指数上升。前后期亟需保护，觉醒完成后优先拿装备牌"
        + "<li>忠臣、反贼：可以捡队友判定区的垃圾来发育，一旦觉醒几乎就能秒掉一人"
        + `<li>内奸：前期先拿${get.poptip("lit_youxia")}控场，发育可以稍慢一些，等全场升级几乎自动发育完成了，有机会抢人头再跳内`,
    ...
    'lit_boshu菠树': `受${get.poptip("lit_yisui")}限制，建议找不容易死，能留牌的角色当${get.poptip("lit_guimi")}（或者打雷伤的）。${B("菠树")}自身完全能够爆发，过牌量堪比半个高达`
        + "<li>主公：完全不推荐，闺蜜给到反贼就废了一半了，而且能留的牌也很少。唯一能想到的打法是利用“闺蜜”+“易碎”可以摸6张初始牌的性质，用手气卡刷出AK，然后突突全场，即便杀到忠臣把AK丢了，损失也不会很大"
    ...
    'lit_zhengmohan郑墨翰': `每回合群体回血+制衡的收益很恐怖，因此跟${B("郑墨翰")}打消耗战很不现实，留点属性牌利用铁索打暴击通常比较好。对${B("郑墨翰")}自己而言，专门控状态打爆发收益不一定高，${get.poptip("lit_jianren")}更多是个保下限的技能`
